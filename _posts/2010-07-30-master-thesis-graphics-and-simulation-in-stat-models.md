...
之前在群众大学给一些客官承诺过我会把我的[硕士毕业论文](http://yihui.name/cn/docs/StatGraphics/Graphics-in-Stat-Models.pdf)发上来，其实早就在网上了，只不过没吱声而已，用Git同步一下容易，但写几个字介绍一下就花时间了。感兴趣的客官可以去本站[作品页面](http://yihui.name/cn/publication/)内下载：[http://yihui.name/cn/publication/#GSM](http://yihui.name/cn/publication/#GSM)
...
[caption id="attachment_1414" align="aligncenter" width="600" caption="坛霸是怎样练成的"][![坛霸是怎样练成的](http://yihui.name/cn/wp-content/uploads/2010/07/cos-bbs-landlord.gif)](http://yihui.name/cn/wp-content/uploads/2010/07/cos-bbs-landlord.gif)[/caption]
